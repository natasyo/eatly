...
const Search: FunctionComponent<SearchProps> = ({ className }) => {
  return (
    <div
      className={`container ${className ? className : ''} :grid-cols-[minmax(578px,_1fr)_268px] md:grid md:grid-cols-[minmax(578px,_1fr)_268px] md:gap-x-10 md:pt-20 xl:grid-cols-[minmax(758px,_1fr)_377px] xl:gap-x-[60px] xl:pt-[120px]`}
    >
