  ...
  return (
    ...
    >
      ...
      <CategorySearch
        ...
        onChangeSearchData={(data: SearchDataType) => {
          dispatch(setSearchState({ data: { ...searchData, ...data } }));
      ...
      <div className="pr-10 xl:pr-[57px]">
        <SearchInput
          ...
          onChangeText={(searchText) => {
            dispatch(setSearchState({ data: { ...searchData, searchText } }));
          }}
        />
        <SearchType
          ...
          current="Food"
          onChange={(type) => {
            dispatch(setSearchState({ data: { ...searchData, type } }));
          }}
        />
      </div>
    </div>
