...
const Restaurants: FunctionComponent<TopRestaurantsProps> = ({ className, classNameHeader }) => {
  ...
  return (
    <div className={`${className ? className : ''}`}>
      <div className="container border-b border-eatly-gray pb-[75px] pt-[85px] sm:pb-[88px] sm:pt-15 lg:pb-28 lg:pt-20 xl:pb-[129px] xl:pt-[86px]">
        <h3
          className={`mx-auto mb-[56px] max-w-[300px] text-center sm:mx-0 sm:mb-12 sm:max-w-full lg:mb-[70px] ${classNameHeader ? classNameHeader : ''}`}
        >
          Our Top <span className="text-eatly-violet">Restaurants</span>
        </h3>
        <div className="grid-cols-3 gap-4 sm:grid sm:px-0 md:gap-[22px] lg:gap-[30px]">
